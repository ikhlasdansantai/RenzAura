  ...
  function MakeUpContents() {
    return (
      <div id="makeup" className="min-h-screen">
        ...
        <div className="cards grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-20 my-10 gap-10">
            ...
            return (
              <>
                <div key={index} className="card flex flex-col gap-4 bg-white p-6  rounded-lg border border-slate-600 dark:border-0">
                  ...
                  <div className="packet-role flex gap-4 overflow-x-scroll">
                    {items.roles.map((role: any) => {
                      return (
                        <div className="flex items-center gap-1 text-secondText bg-slate-700 p-2 rounded-md">
