...
export default function NotFoundPage() {
  ...
  return (
    <section id="error" className="px-4 min-h-screen flex justify-center items-center flex-col text-center">
      <h1 className="mb-4 text-3xl dark:text-white text-gray-900">Oopppps :(</h1>
      <figure>
        <iframe src="https://giphy.com/embed/mqRZe1ud8U3wJoSE3x" width="500" height="330" className="giphy-embed block max-w-full" allowFullScreen>
          <a href="https://giphy.com/gifs/kpop-k-pop-ive-mqRZe1ud8U3wJoSE3x" className="dark:text-gray-500 text-gray-900">
            via GIPHY
          </a>
        </iframe>
      </figure>
      <div className="error-footer mt-4 dark:text-gray-500 text-gray-900">
